...
parser.add_argument("--snrmin", help="Min SNR to include in plot_summary", default=-999, type=float)
parser.add_argument("--snrmax", help="Max SNR to include in plot_summary", default=999, type=float)
args = parser.parse_args(); filename = args.filename; sources = args.sources; mode = args.mode; paramfile = args.paramfile; fileroot=args.fileroot; candnum = int(args.candnum); remove = args.remove; snrmin = args.snrmin; snrmax = args.snrmax
